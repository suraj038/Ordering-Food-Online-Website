...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 14, 2019 at 05:44 AM
...
('suraj', 'suraj@gmail.com', '1234667892', 'asdasdfd', 'sdz'),
('tyrtyew', 'teju@gmail.com', '08050905044', 'hguywtuyq', 'uywqteqywt6euyqwteuqwyteuyqwetuyqwteuyqw'),
('tyrtyew', 'teju@gmail.com', '08050905044', 'hguywtuyq', 'uywqteqywt6euyqwteuqwyteuyqwetuyqwteuyqw');
...
('roshini', 'roshini', 'roshini@gmail.com', '1234567890', 'hjsyudhk', 'roshini'),
('suraj', 'suraj', 'suraj@gmail.com', '1234567892', 'abc', 'suraj'),
('swapnapriya', 'Swapnapriya', 'swapna@gmail.com', '999999999', '1868/3, Swami Vivekanada Badavane', 'swapna'),
('tejaswini', 'tejaswini', 'tejaswinimr1@gmail.com', '7894561230', '2nd floor, 7th main, swami vivekananda badavane , ', 'teju@123'),
('tejaswini M R', 'tejaswini M R', 'teja@gmail.com', '7894561230', '1868/3, Swami Vivekanada Badavane', 'teju@123'),
('teju', 'teju', 'teju@gmail.com', '7894561230', 'abcdef', 'teju');
...
(80, 'Spring Rools', 100, 'Spring roll is a fried dish usually available as a dim sum.', 7, 'images/Spring_Rolls.jpg', 'ENABLE'),
(81, 'Gobi Manchurian', 70, 'manchurian is a sweet, tangy & slightly spicy sauce made with chilli sauce, vinegar, ginger & garlic.', 10, 'images/slides003.jpg', 'ENABLE');
...
('surya', 'surya', 'surya@gmail.com', '7894561230', 'bcvd', 'surya'),
('teju', 'tejaswini', 'teju@gmail.com', '1237894562', 'abcdef', 'teju');
...
(69, 69, 'Coffee', 25, 1, '2019-11-22', 'suraj', 2),
(70, 70, 'Tea', 20, 1, '2019-11-22', 'suraj', 2),
(71, 69, 'Coffee', 25, 1, '2019-11-22', 'suraj', 2),
(72, 70, 'Tea', 20, 1, '2019-11-22', 'suraj', 2),
(73, 71, 'Samosa', 40, 3, '2019-11-22', 'suraj', 2),
(74, 72, 'Paneer Pakora', 45, 5, '2019-11-22', 'suraj', 2),
(75, 61, 'Happy Happy Choco Chip Shake', 80, 1, '2019-11-24', 'suraj', 1),
(76, 69, 'Coffee', 25, 1, '2019-11-24', 'suraj', 2),
(77, 77, 'Pizza', 200, 1, '2019-11-24', 'suraj', 2),
(78, 78, 'French Fries', 75, 1, '2019-11-24', 'suraj', 2),
(79, 73, 'Puff', 35, 1, '2019-11-25', 'suraj', 2),
(80, 80, 'Spring Rools', 100, 1, '2019-11-30', 'suraj', 7),
(81, 80, 'Spring Rools', 100, 1, '2019-11-30', 'suraj', 7),
(82, 81, 'Gobi Manchurian', 70, 1, '2019-11-30', 'suraj', 10),
(83, 80, 'Spring Rools', 100, 1, '2019-11-30', 'suraj', 7),
(84, 81, 'Gobi Manchurian', 70, 1, '2019-11-30', 'roshini', 10),
(85, 81, 'Gobi Manchurian', 70, 1, '2019-11-30', 'swapnapriya', 10),
(86, 60, 'Chocolate Hazelnut Truffle', 99, 1, '2019-11-30', 'swapnapriya', 3),
(87, 69, 'Coffee', 25, 1, '2019-11-30', 'swapnapriya', 2),
(88, 63, 'Baahubali Thali', 75, 1, '2019-12-12', 'suraj', 3);
...
INSERT INTO `reservation` (`first_name`, `last_name`, `state`, `datepicker`, `phone`, `guest`, `email`, `subject`) VALUES
('suraj', 'singh', 'bihar', '2019-11-14', '134567892', 6, 'suraj@gmail.com', 'hi you!');
...
(7, 'surya cafe', 'surya@gmail.com', '7894561230', 'cndjs', 'surya'),
(10, 'teju''s foodee', 'teju1@gmail.com', '7894567890', 'abcdef', 'teju');
